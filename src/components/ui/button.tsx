...
// ButtonLink component for handling links with multiple children
interface ButtonLinkProps extends Omit<React.AnchorHTMLAttributes<HTMLAnchorElement>, keyof VariantProps<typeof buttonVariants>> {
  href: string;
  external?: boolean;
...
const ButtonLink = forwardRef<HTMLAnchorElement, ButtonLinkProps>(
  ({ className, children, variant, size, isLoading = false, href, external = false, ...props }, ref) => {
